      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 mb-12 sm:mb-16">
        ...
        >
          ...
          <div className="flex gap-4">
            <a href="https://github.com/JefferyAddaeSecB" target="_blank" rel="noopener noreferrer" title="GitHub Profile" className="text-foreground hover:text-primary transition-colors">
            ...
            <a href="https://www.linkedin.com/in/jeffery-addae-297214398/" target="_blank" rel="noopener noreferrer" title="LinkedIn Profile" className="text-foreground hover:text-primary transition-colors">
              <svg className="w-5 h-5 sm:w-6 sm:h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"></path><rect width="4" height="12" x="2" y="9"></rect><circle cx="4" cy="4" r="2"></circle></svg>
            </a>
            <a href="mailto:jeffaddai40@gmail.com" title="Email" className="text-foreground hover:text-primary transition-colors">
