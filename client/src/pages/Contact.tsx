      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 relative z-10">
        <div className="lg:col-span-1 space-y-6">
          ...
          >
            <div className="flex space-x-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">jeffaddai40@gmail.com</p>
                <button 
                  ...
                  onClick={() => window.location.href = "mailto:jeffaddai40@gmail.com"}
                >
                  Send an email
          ...
          >
            <div className="flex space-x-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">+1 (437) 499-1703</p>
                <button 
                  className="text-primary p-0 h-auto mt-2 hover:text-primary/80 transition-colors bg-transparent border-0 cursor-pointer inline-flex items-center"
                  onClick={() => window.location.href = "tel:+14374991703"}
                >
                  Make a call
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="ml-1"><path d="M5 12h14"></path><path d="m12 5 7 7-7 7"></path></svg>
                </button>
          ...
          >
            <div className="flex space-x-4">
              ...
              <div>
                ...
                <button 
                  className="text-primary p-0 h-auto mt-2 hover:text-primary/80 transition-colors bg-transparent border-0 cursor-pointer inline-flex items-center"
                  onClick={() => window.open("https://www.google.com/maps/place/Toronto,+Ontario,+Canada", "_blank")}
                >
                  View on map
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="ml-1"><path d="M5 12h14"></path><path d="m12 5 7 7-7 7"></path></svg>
                </button>
          ...
          >
            ...
            <div className="flex space-x-4">
              <a href="https://github.com/JefferyAddaeSecB" target="_blank" rel="noopener noreferrer" title="GitHub Profile" className="text-muted-foreground hover:text-primary transition-colors p-2 bg-background/50 rounded-lg hover:bg-primary/10">
              ...
              <a href="https://www.linkedin.com/in/jeffery-addae-297214398/" target="_blank" rel="noopener noreferrer" title="LinkedIn Profile" className="text-muted-foreground hover:text-primary transition-colors p-2 bg-background/50 rounded-lg hover:bg-primary/10">
                <svg className="w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"></path><rect width="4" height="12" x="2" y="9"></rect><circle cx="4" cy="4" r="2"></circle></svg>
              </a>
              <a href="mailto:jeffaddai40@gmail.com" title="Email" className="text-muted-foreground hover:text-primary transition-colors p-2 bg-background/50 rounded-lg hover:bg-primary/10">
